      SUBROUTINE SEMEP_TAPTAMA(P1,ANS)
C  
...
C  
C FOR PROCESS : e- e+ -> ta+ ta- a  
C  
C Crossing   1 is e- e+ -> ta+ ta- a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=EMEP_TAPTAMA(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION EMEP_TAPTAMA(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL OXXXXX(P(0,4   ),LMASS ,NHEL(4   ),+1*IC(4   ),W(1,4   ))       
      CALL VXXXXX(P(0,5   ),ZERO ,NHEL(5   ),+1*IC(5   ),W(1,5   ))        
      CALL JIOXXX(W(1,3   ),W(1,4   ),GAL ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GAL ,ZERO    ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,6   ),GAL ,AMP(1   ))            
      CALL FVOXXX(W(1,2   ),W(1,5   ),GAL ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL IOVXXX(W(1,1   ),W(1,8   ),W(1,6   ),GAL ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GAL ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL FVOXXX(W(1,4   ),W(1,9   ),GAL ,LMASS   ,ZERO    ,W(1,10  ))    
      CALL IOVXXX(W(1,3   ),W(1,10  ),W(1,5   ),GAL ,AMP(3   ))            
      CALL FVIXXX(W(1,3   ),W(1,9   ),GAL ,LMASS   ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,11  ),W(1,4   ),W(1,5   ),GAL ,AMP(4   ))            
...
C
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          EMEP_TAPTAMA =EMEP_TAPTAMA+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
