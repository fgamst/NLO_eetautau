      SUBROUTINE SEMEP_TAPTAM(P1,ANS)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=EMEP_TAPTAM(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION EMEP_TAPTAM(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          EMEP_TAPTAM =EMEP_TAPTAM+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
