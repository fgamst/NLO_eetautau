      SUBROUTINE SEMEP_TAPTAM_GZ(P1,ANS)
C  
...
C  
C FOR PROCESS : e- e+ -> ta+ ta-  
C  
C Crossing   1 is e- e+ -> ta+ ta-  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=EMEP_TAPTAM_GZ(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION EMEP_TAPTAM_GZ(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,3   ),W(1,4   ),W(1,6   ),GZL ,AMP(2   ))            
      JAMP(   1) = +AMP(   1)+AMP(   2)
      EMEP_TAPTAM_GZ = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          EMEP_TAPTAM_GZ =EMEP_TAPTAM_GZ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
