! C         Last modification on October 20th 2003 by M.S.
! C ==================================================================
...
! C
! C =======================================================================
! C ============== BEGINNING OF THE MAIN PROGRAM ==========================     MARKUS: removed all the content of this file because ifort is giving "catastrophic error"...
! C =======================================================================
! C
      SUBROUTINE HDECAY(IHIG,IMOD,ALSMZ,TGBET,DM_A)
...
!       ihiggs = ihig
!       imodel = imod
!       CALL READ_HDEC(alsmz,TGBET,DM_A,DM_A,1)
!       CALL HEAD_HDEC(TGBET,DM_A)
! 
! C      DO 9999 II=1,NMA
! C       IF(NMA.NE.1)THEN
...
!       SUBROUTINE READ_HDEC(alsmz,TGBET,AMABEG,AMAEND,NMA)
!       IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
! 
! c>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
! c      write(51,('4(1X,G15.8)'))AMA,AML,HBB,SUSY/(SUSY+2*DGLB)
...
! 
! C ===================== THE FUNCTION F0 ===============
!       FUNCTION F0_HDEC(M1,M2,QSQ)
!       IMPLICIT REAL*8 (A-H,M,O-Z)
!       COMPLEX*16 CD,CR,CQ2,IEPS,CBET,CXX,F0_HDEC
!       M1SQ = M1*M1
!       M2SQ = M2*M2
!       AQSQ = DABS(QSQ)
...
!       IMPLICIT DOUBLE PRECISION (A-H,O-Z)
!       COMPLEX*16 X,Y,CLI2_HDEC,LI2_HDEC
